...
public class C04_StaleElementReferenceException extends TestBase {
 ...
 staleelementrefenceexception hatası verir.
    ...
    public void test01() {
        ...
        aramaKutusu.sendKeys("qa", Keys.ENTER); //aramaKutusu eskidiği için sendKEys() methodu kullanamadı
    ...
    @Test
    public void test02() {
        //test02 -->Bu test methodunda test01 methodunun nasil handle edilecegini yaptik
    ...
    public void test04() {
        ...
        //çıkan sonuçlardan ilk ilk beşine tıklayıp her ürünün başlığını konsola yazdıralım
