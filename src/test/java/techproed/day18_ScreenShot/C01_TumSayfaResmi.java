...
public class C01_TumSayfaResmi extends TestBase {
    /*
    SCREENSHOT
        Selenium'da tüm ekran görüntüsünü alabilmek için TakeScreenShot arayüzünden bir obje oluşturup driver'a eşitleriz.
        Arayüzler farklı olduğu için testing yaparız ve bu oluşturduğumuz obje ile getScreenshotAs methodu ile sayfanın resmini alırız.
        Almış olduğumuz resmi projemizde nereye kaydedeceksek oranın yolunu belirtiriz.
     */
    @Test
    public void test01() throws IOException {
        ...
        /*
        İlk olarak screenshot aldığımızda nereye kaydetmek istiyorsak oranın yolunu belirtelim
