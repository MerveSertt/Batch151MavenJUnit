...
public class C01_ExtentReport extends TestBase {
    ...
    /*
    EXTENTREPORT;
       1- ExtentReport kullanabilmek için öncelikle mvn adresinden 4.0.9 versiyon numaralı dependency'i pom.xml dosyamıza ekleriz.
       2- ExtentReports class'ından class seviyesinde obje oluştururuz.
       3- ExtentHtmlReporter classından class seviyesinde obje oluştururuz.
       4- ExtentTest classından class seviyesinde obje oluştururuz.
     */
    ...
    public void test01() {
        ...
        extentTest.pass("Sayfa kapatıldı"); //Bu ikisi de aynı görevi görür sadece pass methodu en sonda test methodu bitirileceği zaman yazılır.
